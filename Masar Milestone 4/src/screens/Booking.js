...
import { View, Text, TextInput, TouchableOpacity, ScrollView, useColorScheme, Platform, Modal, Alert } from 'react-native';
import DateTimePicker from '@react-native-community/datetimepicker';
import { lightTheme, darkTheme } from '../theme/colors';
import { UserContext } from '../context/UserContext';
import Header from '../components/Header';
import { Calendar, X, Clock, Train, MapPin, ArrowRight } from 'lucide-react-native';
import { ALL_STATIONS, EGYPT_RAIL_STATIONS, CAIRO_METRO_STATIONS, calculatePrice, getStationLine, LINE_1_STATIONS, LINE_2_STATIONS, LINE_3_STATIONS } from '../utils/stationData';
...
export default function Booking({ navigation }) {
  const { appTheme, createBooking } = useContext(UserContext);
              ...
              <TouchableOpacity
                ...
                onPress={async () => {
                  ...
                  Alert.alert(
                    ...
                    [
                      { text: 'Cancel', style: 'cancel', onPress: () => setSelectedTrain(null) },
                      {
                        text: 'Book Now',
                        onPress: async () => {
